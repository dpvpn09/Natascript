...
#install ssh ovpn
wget https://raw.githubusercontent.com/dpvpn09/rev/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
#install v2ray
wget https://raw.githubusercontent.com/dpvpn09/rev/main/websocket.sh && chmod +x websocket.sh && screen -S v2ray ./websocket.sh
